...
export default function PriorityUrgency({ form, onInputChange }) {
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 lg:gap-10 rounded-[4px] border border-solid border-neutral-300 dark:border-neutral-600 p-6">
          ...
          <div className="mb-[0.125rem] inline-block min-h-[1.5rem] pl-[1.5rem]">
            <input
              ...
              id="inlineRadio1"
              value="low"
              checked={form.priority_level === "low"}
              disabled={!isCreate}
              name="priority_level"
          ...
          <div className="mb-[0.125rem] inline-block min-h-[1.5rem] pl-[1.5rem]">
            <input
              ...
              id="inlineRadio2"
              value="medium"
              checked={form.priority_level === "medium"}
              disabled={!isCreate}
              name="priority_level"
              onChange={(e) => onInputChange(e)}
            />
          ...
          <div className="mb-[0.125rem] inline-block min-h-[1.5rem] pl-[1.5rem]">
            <input
              ...
              id="inlineRadio3"
              value="high"
              checked={form.priority_level === "high"}
              disabled={!isCreate}
              name="priority_level"
              onChange={(e) => onInputChange(e)}
            />
          ...
          <div className="mb-[0.125rem] inline-block min-h-[1.5rem] pl-[1.5rem]">
            <input
              ...
              id="inlineRadio4"
              value="critical"
              checked={form.priority_level === "critical"}
              disabled={!isCreate}
              name="priority_level"
              onChange={(e) => onInputChange(e)}
            />
